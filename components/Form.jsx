  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <p className="desc text-left max-w-md">
        {type} and share anzmazing prompts with the world, and let your imagination run wild with any AI-powered platform.
      </p>

      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        <lable>
          <span className="font-satoshi font-semibold textbase text-gray-700">
            Your AI Prompt
          </span>
